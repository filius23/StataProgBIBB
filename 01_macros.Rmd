...
foreach lname of varlist  variablen  {
...
Fizz Buzz wird/wurde ein Screening-Instrument für Programmierer\*innen verwendet. Fizz Buzz ist ein Kinderlernspiel, bei dem die Kinder üblicherweise im Kreis sitzen und reihum laut von eins aufwärts zählen. Allerdings gibt es drei Regeln:
...
Diskutieren Sie erst in der Gruppe, wie Sie mit `if` & `else` eine Schleife bauen würden, welche diese Regeln umsetzt. 
